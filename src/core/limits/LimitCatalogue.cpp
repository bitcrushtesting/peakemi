...
{
    return LimitPoint{
        .frequency = frequency, .amplitude = amplitude, .interpolationToNext = interpolation};
}
...
[[nodiscard]] std::vector<LimitLine> makeCatalogue()
{
    ...
    catalogue.push_back(
        LimitLine{.name = "CISPR 32 Class B conducted (QP)",
                  ...
                  .points = {breakpoint(kilohertz(150), 66.0),
                             ...
                             breakpoint(megahertz(5), 60.0, Interpolation::Step),
                             breakpoint(megahertz(30), 60.0, Interpolation::Step)}});

    catalogue.push_back(
        LimitLine{.name = "CISPR 32 Class B conducted (AV)",
                  .standard = "CISPR 32:2015 / EN 55032:2015, Table A.3",
                  ...
                  .points = {breakpoint(kilohertz(150), 56.0),
                             ...
                             breakpoint(megahertz(5), 50.0, Interpolation::Step),
                             breakpoint(megahertz(30), 50.0, Interpolation::Step)}});

    catalogue.push_back(
        LimitLine{.name = "CISPR 32 Class A conducted (QP)",
                  ...
                  .points = {breakpoint(kilohertz(150), 79.0, Interpolation::Step),
                             ...
                             breakpoint(megahertz(30), 73.0, Interpolation::Step)}});

    catalogue.push_back(
        LimitLine{.name = "CISPR 32 Class A conducted (AV)",
                  .standard = "CISPR 32:2015 / EN 55032:2015, Table A.6",
                  .note = "Mains port, average detector.",
                  .kind = EmissionKind::Conducted,
                  .equipmentClass = EquipmentClass::ClassA,
    ...
    catalogue.push_back(
        LimitLine{.name = "CISPR 32 Class B radiated 10 m (QP)",
                  ...
                  .points = {breakpoint(megahertz(30), 30.0, Interpolation::Step),
                             ...
                             breakpoint(gigahertz(1.0), 37.0, Interpolation::Step)}});

    catalogue.push_back(
        LimitLine{.name = "CISPR 32 Class A radiated 10 m (QP)",
                  ...
                  .points = {breakpoint(megahertz(30), 40.0, Interpolation::Step),
                             ...
                             breakpoint(gigahertz(1.0), 47.0, Interpolation::Step)}});

    // --- FCC 47 CFR Part 15 subpart B ---------------------------------------
    catalogue.push_back(
        LimitLine{.name = "FCC Part 15B Class B conducted (QP)",
    ...
    catalogue.push_back(
        LimitLine{.name = "FCC Part 15B Class A conducted (QP)",
    ...
    catalogue.push_back(
        LimitLine{.name = "FCC Part 15B Class B radiated 3 m (QP)",
                  ...
                  .points = {breakpoint(megahertz(30), 40.0, Interpolation::Step),
                             ...
                             breakpoint(gigahertz(1.0), 54.0, Interpolation::Step)}});

    catalogue.push_back(
        LimitLine{.name = "FCC Part 15B Class A radiated 10 m (QP)",
                  ...
                  .points = {breakpoint(megahertz(30), 39.0, Interpolation::Step),
                             ...
                             breakpoint(gigahertz(1.0), 49.5, Interpolation::Step)}});
...
std::optional<LimitLine> builtInLimitLine(std::string_view name)
{
    ...
    const auto found = std::find_if(catalogue.begin(),
                                    catalogue.end(),
                                    [name](const LimitLine& line) { return line.name == name; });
